    ...
    <Stack justifyContent={'flex-start'} mt={is480 ? 3 : 5} mb={'14rem'} alignItems={'center'}>
      {
        wishlistFetchStatus === 'pending' ?
          ...
          <Stack sx={{ width: '100%', maxWidth: '70rem', px: is480 ? 2 : 0, boxSizing: 'border-box' }} rowGap={is480 ? 2 : 4}>
            ...
            <Stack >

              {
                !wishlistFetchStatus === 'pending' && wishlistItems?.length === 0 ? (
                  ...
                  <Stack minHeight={'60vh'} sx={{ width: '100%', maxWidth: '40rem', px: is642 ? 2 : 0, boxSizing: 'border-box' }} justifySelf={'center'} alignSelf={'center'} justifyContent={'center'} alignItems={'center'}>
