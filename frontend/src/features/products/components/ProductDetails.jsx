            ...
            {!(productFetchStatus === 'rejected' && reviewFetchStatus === 'rejected') && <Stack sx={{ justifyContent: 'center', alignItems: 'center', mb: '2rem', rowGap: "2rem" }}>
                {
                    (productFetchStatus || reviewFetchStatus) === 'pending' ?
                        ...
                        <Stack>
                            ...
                            {/* product details */}
                            <Stack
                                sx={{ width: '100%', maxWidth: '88rem', px: is480 ? 2 : 0, boxSizing: 'border-box' }}
                            ...
                            >
                                            ...
                                            product && product.images.map((image, index) => (
                                                <motion.div
                                                    ...
                                                    style={{
                                                        ...
                                                        cursor: "pointer",
                                                        border: selectedImageIndex === index ? "2px solid #DB4444" : "2px solid transparent",
                                                        borderRadius: "8px",
                                                        overflow: "hidden"
                                                    }}
                                                                ...
                                                                <div key={index} style={{ width: "100%", height: '100%' }}>
                                                                    {
                                                                        Math.abs(activeStep - index) <= 2
                                                                            ...
                                                                            <Box
                                                                                ...
                                                                                sx={{
                                                                                    width: '100%',
                                                                                    height: is480 ? '300px' : is990 ? '400px' : '500px', // Fixed height
                                                                                    objectFit: "contain",
                                                                                    overflow: "hidden"
                                                                                }}
                                                                                src={image}
                                ...
                                <Stack rowGap={"1.5rem"} sx={{ width: '100%', maxWidth: '25rem', flex: '1 1 320px' }}>
