...
export const Signup = () => {
  ...
  return (
    <Stack
      // was: width={'100vw'} height={'100vh'} flexDirection={'row'} sx={{overflowY:"hidden"}}
      sx={{
        width: '100%',
        minHeight: '100vh',
    ...
    >
      ...
      <Stack flex={1} justifyContent={'center'} alignItems={'center'} sx={{ px: { xs: 2, sm: 3, md: 0 } }}>
        <Stack flexDirection={'row'} justifyContent={'center'} alignItems={'center'}>
          <Stack rowGap={'.4rem'}>
            {/* make heading scale down on small screens */}
            <Typography
              variant='h2'
              sx={{ wordBreak: "break-word", fontSize: { xs: '1.75rem', sm: '2rem', md: '3rem' } }}
              fontWeight={600}
            >
              Mern Shop
            </Typography>
        ...
        {/* form container responsive width + padding */}
        <Stack
          mt={4}
          spacing={2}
          component={'form'}
