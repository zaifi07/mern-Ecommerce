...
export const UserProfile = () => {
    ...
    return (
        <Stack height={'calc(100vh - 4rem)'} justifyContent={'flex-start'} alignItems={'center'} style={{ overflowY: 'auto' }} p={2} rowGap={2}>

            <Stack component={is480 ? '' : Paper} elevation={1} width={is900 ? '100%' : "50rem"} p={2} mt={is480 ? 0 : 5} rowGap={2}>

                {/* user details - [name ,email ] */}
                <Stack bgcolor={theme.palette.background.default} color={theme.palette.primary.main} p={2} rowGap={1} borderRadius={'.6rem'} justifyContent={'center'} alignItems={'center'}>
