            ...
            <Stack flexDirection={'row'} rowGap={'1rem'} justifyContent={is700 ? "" : 'space-around'} flexWrap={'wrap'}>
                ...
                <Stack rowGap={'1rem'} padding={'1rem'}>
                    ...
                    <TextField
                        ...
                        sx={{
                            border: `1px solid ${theme.palette.divider}`, // Using theme divider color
                            borderRadius: "6px"
                        }}
                        InputProps={{
                            endAdornment: (
                                <IconButton>
                                    <SendIcon sx={{ color: theme.palette.text.secondary }} />
                                </IconButton>
                            ),
                            style: { color: theme.palette.text.primary } // Using theme text color
                        }}
                    />
                </Stack>
                ...
                <Stack rowGap={'1rem'} padding={'1rem'}>
                    ...
                    <Typography sx={{
                        ...labelStyles,
                        color: theme.palette.text.secondary, // Using theme secondary text color
                        fontWeight: 500
                    }}>
